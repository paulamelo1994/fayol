...
<a href="./index.php?view=newreservation" class="btn btn-info">Nueva Reservación</a>
<a href="./index.php?view=oldreservations" class="btn btn-default">Reservas Anteriores</a>
<br><br>
