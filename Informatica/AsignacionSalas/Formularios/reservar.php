 ...
 ?>
    <form name="reservaSalas" method="post" enctype="multipart/form-data" action="envioReserva.php" id="reservaSalas">
        ...
        <tr>
            ...
            <td><input readonly name="fecha_reserva" size="30" value="<? echo $fecha_reserva;?>"  id="fecha_reserva" type="text" />&nbsp;(aaaa:mm:dd)</td>
        </tr>
        <tr>
...
<!-- http://administracion.univalle.edu.co/Comunidad/Informatica/AsignacionSalas/Formularios/reservar.php?fecha_sel=2011-03-10&hora=14:00&sala=1-->
