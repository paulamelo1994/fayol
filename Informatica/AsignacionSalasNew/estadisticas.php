<? ini_set("memory_limit",-1);
	...
	if(isset($_POST['est'])){
		...
		if($tipo=='1'){
			...
			$query=$query." fecha_reserva >= '2011-05-01' and fecha_reserva<= '2011-06-06' group by sala,tipo_reserva";
			$rs=db_query($query);
			...
			$query=$query." fecha_reserva >= '2011-05-01' and fecha_reserva<= '2011-06-06' group by sala,docente";
			$rs=db_query($query);
		}
		...
		<table align="center"  id="Exportar_a_Excel">
        	<tr>
            	<td align="center"><strong><h2>Reporte por:  <? echo $title;
					if($sala=='5'){ echo ' -  Todas las salas';}else{ echo ' -  Sala '.$sala;} ?></h2></strong><br /></td>
            </tr>
            <tr>
            	<td><strong>Fecha reporte: </strong><? echo MakeDate($fecha); ?></td>
            </tr>
            <tr>
            	<td><strong>Elaborado por:</strong> Luis Guillermo Peña</td>
            </tr>
            <tr>
            ...
            <tr>
            	<td >
                	<table align="center" width="350">
						 ...
						 if($i==0){ $color='#DBDBDB'; $i=1;}else{ $color='CCCCCC'; $i=0;}
						 ?>
                         <tr>
