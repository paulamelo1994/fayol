	...
	include '../../../../php-scripts/validadorFormularios/formReserva.php';
	 ...
	 DBConnect('controlsalas');
		...
		if($objp->cantidad >0){
			...
			location.href="/Comunidad/Informatica/AsignacionSalasNew/calendarioMensual.php";
			</script> <?
		}else{
...
<input type="hidden" name="sala" value=<?=$obj->sala?>>
	...
	<table border="0" align="center" width="60%">
		...
		<tr>
			...
			<td align="center"><input type="button" name="regresar" value="Regresar" onClick="location.href='/Comunidad/Informatica/AsignacionSalasNew/calendReserva.php?opcion=3&fecha=<?=$obj->fecha_reserva?>'"/></td>
		</tr>
	</table>
</form>
