<?
	...
	Objetivo: Este archivo es el encargado de dar material en consignación a la ubicación respectiva, inicialmente 
	          los materiales ingresan a la bodega y de alli se distribuyen a la ubicación que corresponda. 
			  La cantidad en consignación se resta del inventario de la ubicación que consigna y se adiciona a la 
			  ubicación que recibe el material, adicionalmente se guarda un registro de la operación.			  
	Autor: Deisy Chaves
	Año: 2008
	*********************************************************/
	session_start();
	...
	if(isset($_POST['aceptar']))
	{
		...
		else
		{
			...
			{		
				...
				$rs=null;
				//se recupera la información de la ubicación que recibe
				...
				//Si hay existencias suficientes para realizar la consignación
				if($existencias>0)
				{				
