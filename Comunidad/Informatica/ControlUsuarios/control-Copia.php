...
?>
		...
		<center>
		<form method="post" action="control-Copia.php" name="autenticacion" enctype="multipart/form-data">
...
<?
	...
	if(isset($_SESSION['monitor']))
	{
		...
		$tiempo_transcurrido = (strtotime($ahora)-strtotime($fechaGuardada));
		 ...
		 {
		 	session_destroy();
			header("Location: control-Copia.php?caducado=true");
		}
	...
	?>
			<form method="get" name="ControlSalas" action="control-Copia.php">
			...
			if($_SESSION['idsala'] == "Pendiente")
			{
				...
				while($obj = pg_fetch_object($rs))
				{
					...
					{
				?>
					<option onClick="document.location.href='control-Copia.php?sala=<?=$obj->codigosala?>'"><?=$obj->codigosala?></option>
				<?	
					}
				}
				?>
