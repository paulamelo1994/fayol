	...
	else
	{
		...
		<tr>
			...
			<tr>
				...
				<td><input type="text" name="email" readonly size="30" value="<?=$email?>"></td>
			</tr>
			<tr><td><br></td></tr>
			<tr>
			...
			<tr>
				...
				<td>
				<input  type="text" name="equipo" id="equipo"  size="10" maxlength="10" value="" title="Seleccione un equipo disponible del lado derecho!">
				</td>
			</tr>
			<tr><td><br></td></tr>
			...
			<tr>
				...
				<?php
                                    $conexion = DBConnect('controlsalas');
                                    $query = 'SELECT * FROM sala_software';
                                    /**$result = $conexion->query("SELECT ¨* FROM sala_software");*/
                                    $rs = db_query("SELECT * FROM sala_software  WHERE sala='Cuse' ORDER BY id ASC");
                                    $i = 0;
                                    $tmp = 1;
                                ...
                                ?>
                                    ...
                                    <?php    
                                        ...
                                        $idSoftware = $obj->id;
					$nomSoftware = $obj->software;
                                    ?>   
                                    <option value=" <?php echo $idSoftware; ?> " >
                                    <?php echo $nomSoftware; ?>
                                    </option>       
                                    <?php
                                        }    
                                    ?>        
