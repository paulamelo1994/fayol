<?
	...
	Año: 2006
	Modificacion : 02-2011 por Andrea Cordoba
	*********************************************************/
	...
	if($_POST['autenticar'])
	{
		...
		if(($_POST['Login']=='luispena')&&($_POST['Password']=='luisxx'))
		{
		...
		else
		{
			echo "<script language=\"Javascript\" >
				...
				location.href='/Comunidad/Informatica/AsignacionSalasNew/Formularios/ingresar.php';
                </script>";
		}
	}
	...
	if(isset($_SESSION['adminSalas']))
	{
		...
		PageInit("Asignación de Salas ", '../menu.php');
		?>
