...
$date=date("Y-m-d");
   ...
   {   		
	  $consulta1=db_query("select count (id)as cantidad,habilidad from calificacionsoporte where fechacalificacion>='$ano-01-01' and fechacalificacion<='$date'  group  by habilidad;");
	   ...
	   $excelente=0;
		...
		//$graph->title->Set("Nivel Atencion - Habilidad");
