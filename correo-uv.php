...
function nombreServidor($login,$passwd) {
 ...
 $ldaphost = "ldap://univalle.edu.co/";  //calvin.univalle.edu.co
...
*//*
	...
	header("Location: https://proxse24.univalle.edu.co/correo/src/redirect.php?login_username=$login_username&secretkey=$secretkey&js_autodetect_results=0just_logged_in=1");
?>
