...
?>
	<H1 class="shiny"><?= IMAGEN_ACTAS ?> Actas del Consejo de Facultad </H1>
...
<tr>
	...
	if(pg_num_rows($query1) != 0 ){
		 ...
		 while($obj1=pg_fetch_object($query1)){?>
		 	<A HREF="index.php?agno=<? echo $obj1->anno; ?>" TARGET="_self"> <?= IMAGEN_ACTAS_MINI ?> A&ntilde;o <? echo $obj1->anno; ?> </A><br><br>
		 <?
		}
	}
	 ?>
	 <A HREF="index.php?agno=2010" TARGET="_self"> <?= IMAGEN_ACTAS_MINI ?> A&ntilde;o 2010</A><br><br>
	 <A HREF="index.php?agno=2009" TARGET="_self"> <?= IMAGEN_ACTAS_MINI ?> A&ntilde;o 2009</A><br><br>
	 <A HREF="index.php?agno=2008" TARGET="_self"> <?= IMAGEN_ACTAS_MINI ?> A&ntilde;o 2008</A><br><br>
	 <A HREF="index.php?agno=2007" TARGET="_self"> <?= IMAGEN_ACTAS_MINI ?> A&ntilde;o 2007</A><br><br>
	 <A HREF="index.php?agno=2006" TARGET="_self"><?= IMAGEN_ACTAS_MINI ?> A&ntilde;o 2006</A><br><br>
	 <A HREF="index.php?agno=2005" TARGET="_self"><?= IMAGEN_ACTAS_MINI ?> A&ntilde;o 2005</A><br><br>
