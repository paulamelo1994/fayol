...
<?
  ...
  function DibujarMes($mes, $ano, $mod, $nuevoEvento)
  {
	...
	global $meses;
	 ...
	 # Tomo el dia, mes y a&ntilde;o actuales
	 $time = time();
	 ...
	 <TD WIDTH=68><center>S&aacute;bado</center></TD></TR>';

	 # El calendario siempre debe tener 6 semanas para que sean del mismo tama&ntilde;o
	 $numeroSemanas = 0;
  ...
  # Devuelve (mes siguiente, su respectivo a&ntilde;o)
  ...
  # Devuelve (mes anterior, su respectivo a&ntilde;o)
